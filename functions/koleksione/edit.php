...
if ($id) {
$query="SELECT * FROM koleksionet WHERE id = {$id}";
...
label {
    ...
    <div class="col py-2">
    <label >Titulli</label>    
         <input type="text" id="titull" name="titull" class="form-control" value="<?php echo $row["titull"]?>">  
    </div>


    <div class="col py-2">
    <label >Nentitull</label>    
         <input type="text" id="nentitull" name="nentitull" class="form-control" value="<?php echo $row["nentitull"]?>">  
    </div>
